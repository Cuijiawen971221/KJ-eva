...
ti
    ...
    """
    # 信息文件路径
    info_file = os.path.join(config_dir, 'TFB_info_ecmwf.txt')
    temp_file = os.path.join(config_dir, 'TFB_info_ecmwf_temp.txt')  # 临时文件用于原子更新
                ...
                for method in methods:
                    ...
                    if True:#os.path.exists(retry_filen) and not os.path.exists(ok_filen):
                        ...
                        if True:
                            ...
                            #print(folder_name)
                            ## 执行GVT定位
                            os.chdir('/vol8/home/kongjun/VERIFY/OBS_typhoon/codes/typhoon_his/GVT_orig/EC_codes/')
