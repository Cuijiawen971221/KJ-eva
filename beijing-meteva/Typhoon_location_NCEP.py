                ...
                for method in methods:
                    ...
                    if True:#os.path.exists(retry_filen) and not os.path.exists(ok_filen):
                        ...
                        if True:
                            ...
                            #print(folder_name)
                            ## 执行GVT定位
                            os.chdir('/vol8/home/kongjun/VERIFY/OBS_typhoon/codes/typhoon_his/GVT_orig/NCEP_codes/')
                            cmd_info = f'yhrun -p test -N 1 sh run_ncep_test.sh {folder_name}'
                            os.system(cmd_info)
...
if __name__ == "__main__":
    # 配置目录
    config_dir = "/vol8/home/kongjun/VERIFY/OBS_typhoon/tfb_mess/"
