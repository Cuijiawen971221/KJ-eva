...
if __name__=="__main__":
    ...
    fcst_n_list = ['NCEP','KT1279']##,'NCEP','KT1279']#'NCEP','KT1279','ECMWF']#,'NCEP','KT1279']#['ECMWF','KT1279','NCEP','CMA-GFS','AUTO']
    obs_n_list  = ['AWS']#,'CMPAS','GPM','ERA5','AWS']
    region_n_list = ['101']###,'101','102','103','104','105','106','107']#[1,2,3,4,5,6]## 100,101,102,103,104,105,106,107
    rainscale_list = [24]
    ## 获取系统当前的时间
